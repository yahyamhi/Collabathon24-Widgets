...
function Dashboard() {
  const initialWidgets = [
    ...
    { id: 'cashFlow', title: 'Cash Flow', visible: true, description: 'Shows cash flow insights' }, // Add the Cash Flow widget entry
  ];
          ...
          .map((widget) => (
            <div key={widget.id} className="widget-item">
              ...
              >
                ...
                ) : widget.id === 'cashFlow' ? ( // Render CashFlowWidget when its ID matches
                  <CashFlowWidget />
                ) : (
