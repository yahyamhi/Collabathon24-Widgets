...
const BranchFinderWidget = () => {
  ...
  const [fetchUrl, setFetchUrl] = useState(`/api/branches?city=Hamburg&street=Mönckebergstraße&type=P`);  // Default API fetch on load
        ...
        <div className="scrollable-list">
          {data && data.map((branch, index) => (
            <div key={index} className="branch-item">
              ...
              <p>
                <strong>Phone:</strong> {branch.telefon}
              </p>
